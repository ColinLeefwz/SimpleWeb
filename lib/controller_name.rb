...
module ControllerName
  ...
  Right= {
    0=>{
          "admin_users"=>"用户列表",
          "admin_kx_users"=>"可信用户",
          "admin_co_users"=> '外部授权用户',
          "admin_user_logos" => '头像审核',
          "user_chatroom_upload_photos" => '聊天室上传图片',
          "admin_gchat_content_review" =>'聊天室内容审核',
          "admin_photo_censor" =>'聊天室图片审核',
          "admin_blacks"=>"举报用户",
    ...
    1=>{
          ...
          "admin_user_reports" => "用户地点报错查看",
          "admin_groups" => "群组管理",
          "admin_shop_notices"=>"商家公告",
          "admin_shop_faqs"=>"商家问答",
          "admin_shop_logos"=>"商家logo",
          "admin_shop_coupons"=>"商家优惠券",
          "admin_shop_photos"=>"照片墙",
          "admin_shop_bans"=>"商家屏蔽用户",
          "admin_shop_bindwbs"=>"商家绑定微博",
          "admin_shop_signs"=>"合同管理",
          "admin_sina_pois"=>"微博地点",
          "admin_baidu"=>"百度地点",
          'admin_similar_shops' => "相似地点"
        },
    2 => {
          'admin_shop_coupons' => "商家优惠券",
          "admin_coupon_reports" => "最新下载"
         },
    ...
    8=>{},
    9=>{"checkin_days"=>"每日签到", "admin_activity_shop_day_stats"=>"活动商家每日新增用户首次签到统计","shop_checkin_stats"=>"商家签到统计",
