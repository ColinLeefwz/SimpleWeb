...
{    
    ...
    if (url && [url isKindOfClass:[NSURL class]]) {
		...
		NSLog(@"ShopsNearby launchOptions = %@", url);
    }    
    ...
    self.viewController.wwwFolderName = @"phone";
...
{
    float latitude = 30.277359643785; 
    float longitude = 120.11278551855; 
    //http://www.anttna.com/goffset/goffset1.php?lat=30.279625&lon=120.107979
