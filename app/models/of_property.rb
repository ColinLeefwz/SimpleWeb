class OfProperty < ActiveRecord::Base
  ...
  def self.user_integrate(host, db_name)
    ...
    OfProperty.create_or_update  "jdbcAuthProvider.passwordSQL","select password from users where id=?"
    ...
    OfProperty.create_or_update  "jdbcUserProvider.allUsersSQL","select * from users;"
    OfProperty.create_or_update  "jdbcUserProvider.loadUserSQL","select name from users where id = ?"
    OfProperty.create_or_update  "jdbcUserProvider.userCountSQL","select count(*) from users"
    OfProperty.create_or_update  "provider.admin.className","org.jivesoftware.openfire.admin.DefaultAdminProvider"
    OfProperty.create_or_update  "provider.auth.className","org.jivesoftware.openfire.auth.DfaceAuthProvider"
    ...
    OfProperty.create_or_update  "provider.user.className","org.jivesoftware.openfire.user.DfaceUserProvider"
