...
get_message2(Jabber=#jabber{type = 'auth_sasl_bind0'}) ->
    auth_sasl_bind0(Jabber);
...
%%----------------------------------------------------------------------
auth_sasl_bind0(#jabber{username=Name,passwd=Passwd,domain=Domain})->
        auth_sasl_bind0(Name, Passwd, Domain).
...
%%----------------------------------------------------------------------
auth_sasl_bind0(_Username, _Passwd, _Domain) ->
 list_to_binary(["<stream:stream xmlns='jabber:client' xmlns:stream='http://etherx.jabber.org/streams' version='1.0' to='dface.cn'>"]).
