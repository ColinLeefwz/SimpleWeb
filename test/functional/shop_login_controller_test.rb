...
class ShopLoginControllerTest < ActionController::TestCase
  ...
  test '没有开通密码的商家登陆10次ip封一个小时' do
    post :login, :id => 112, :password => '123456'
    assert_equal "密码输入错误，您还有9次机会", flash[:notice]
    7.times {post :login, :id => 112, :password => '123456'}
    post :login, :id => 112, :password => '123456'
