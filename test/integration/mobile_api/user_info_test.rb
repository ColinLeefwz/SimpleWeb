...
class UserInfoTest < ActionDispatch::IntegrationTest
  test "设置，查看个人信息" do
    ...
    get "/user_info/get_self"
    assert_response :success
    assert_equal JSON.parse(response.body), {"gender"=>1,"hobby"=>"","invisible"=>0.0,"jobtype"=>nil,"name"=>"袁乐天","oid"=>154.0,"password"=>"c84dad462d5b7282","signature"=>"","wb_uid"=>"a1","pcount"=>0,"id"=>"502e6303421aa918ba000005","logo"=>"","logo_thumb"=>"","logo_thumb2"=>""}
    ...
    assert_response :success
    assert_equal response.body, {"error"=>"not login"}.to_json
    assert_equal luser.reload.attributes, {"_id"=> luser.id,"gender"=>1,"hobby"=>"","invisible"=>0.0,"jobtype"=>nil,"name"=>"袁乐天","oid"=>154.0,"password"=>"c84dad462d5b7282","signature"=>"","wb_uid"=>"a1","pcount"=>0}
    ...
    get "/user_info/get_self"
    assert_response :success
    assert_equal JSON.parse(response.body), {"birthday"=>"1988-08-08","gender"=>1,"hobby"=>"计算机","invisible"=>0.0,"job"=>"程序员","jobtype"=>1,"name"=>"测试name","oid"=>154.0,"password"=>"c84dad462d5b7282","pcount"=>0,"signature"=>"测试签名档","wb_uid"=>"a1","id"=>"502e6303421aa918ba000005","logo"=>"","logo_thumb"=>"","logo_thumb2"=>""}
