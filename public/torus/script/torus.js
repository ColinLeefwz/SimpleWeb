...
window.addEventListener("load", function () {
    document.getElementById('loading').innerHTML = '<a onclick="dface_close()" style="float:right;">X</a><br/><br/><br/><br/><h1>游戏d介绍</h1><br/>向←滑动:  底盘顺时针转动<br/>向→滑动:  底盘逆时针转动 <br/>向 ↑ 滑动:     变形<br/> 向 ↓ 滑动: 快速降落<br/>\n\
