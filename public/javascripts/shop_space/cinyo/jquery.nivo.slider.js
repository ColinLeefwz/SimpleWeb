...
(function(jQuery) {
    ...
    var NivoSlider = function(element, options){
        ...
        if(settings.directionNav){
            ...
            jQuery('a.nivo-prevNav').live('click', function(){
            ...
            jQuery('a.nivo-nextNav').live('click', function(){
                if(vars.running) return false;
                clearInterval(timer);
                timer = '';
	...
	jQuery.fn.nivoSlider.defaults = {
		effect: 'random',/**randomʾʾЧjquery.nivo.slider.pack.jsпԿsliceDownRight,sliceDownLeft,sliceUpRight,sliceUpLeft,sliceUpDown,sliceUpDownLeft,fold,fade,boxRandom,boxRain,boxRainReverse,boxRainGrow,boxRainGrowReverseȹ13ʾЧ**/
		slices: 15,/**ʾһͼָ15򣬴˴Ϊ1עԽԵԵcpuҪԽߣٶȾԽŵ1000ͿԿЧˡpauseTimeͣʱֻ3000ü޽ֻ40ѡ**/
		boxCols: 8,
		boxRows: 4,
		animSpeed: 500,/**ʱ䳤**/
		pauseTime: 3000,/**ͣʱ**/
		startSlide: 0,/**ҳʱĬһͼƬʾ0һţ1ڶţ2ţԴơ**/
		directionNav: true,/**Ƿʾҳҷҳͷtrueʾfalseʾ仰עĬΪʾ**/
		directionNavHide: true,/**ڿҷҳͷtrueƶͷλʱͷʾƵʾfalse:ͷԶʾûƶͷϣͷȻü仰עĬΪ겻ϲʾ**/
		controlNav: true,/**ڿϽǵĵtrueʾfalseʾ仰עĬΪʾ**/
		controlNavThumbs: false,/**ڿƵÿʾֵĻʾͼģtrueʾʾͼfalseʾʾ֡仰עĬΪʾ֡**/
        controlNavThumbsFromRel: false,/**Ƿʹ_thumb.jpgΪ׺ͼƬtrueʾãfalseʾ**/
		controlNavThumbsSearch: '.jpg',/**.jpg޸ĳ.gifʱ"controlNavThumbsReplace: '_thumb.jpg'"ã㽫ῴʾЧ<a class="nivo-control" rel="2"><img alt="" src="images/3.jpg" complete="complete"/>3_thumb.jpg3.jpgȡ**/
		controlNavThumbsReplace: '_thumb.jpg',/**õcontrolNavThumbs:trueʱͼĺ׺ʽ**/
		keyboardNav: true,
		pauseOnHover: true,/**ͣͼƬ򵼺ʱǷͣtrueʾͣfalseʾͣ仰עĬΪͣ**/
		manualAdvance: false,/**ֲͼǷԶУfalseʾԶУtrueʾ񡣽仰עĬΪԶС**/
		captionOpacity: 0.8,/**͸**/
		prevText: 'Prev',/**ͷı**/
		nextText: 'Next',/**Ҽͷı**/
		beforeChange: function(){},/**beforeChangeڷͼƬ任ǰһζʼʱҪִеĺ**/
		afterChange: function(){},/**afterChangeڷͼƬ任꣨һζʱҪִеĺ**/
		slideshowEnd: function(){},/**slideshowEndڷֲͼִһѭʱҪִеĺ**/
        lastSlide: function(){},
        afterLoad: function(){}/**afterLoadڷöʱҪִеĺ**/
	};
