def helper_objects
  ...
  #sessions
  let(:firtst_session){create :session, title: 'Intro Session to Lean Start-Up', expert: peter,
			   description: 'How can lean start-up methods help me build a better business?',
			   status: 'Upcoming',
			   image_url: 'compass.jpg'}

  let(:second_session){create :session, title: 'Communicating With Chinese', expert: peter,
