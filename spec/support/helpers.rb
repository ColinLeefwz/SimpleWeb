def helper_objects
  ...
  #profile
  let(:sameer_profile) {create :expert_profile, title: "VP of stuff", company: "OC", location: "Shanghai", education: "UCLA", career: "Originate", expert: sameer}
  let(:alex_profile) {create :expert_profile, title: "Founder of Prodygia", company: "Prodygia", location: "Beijing", education: "UCLA", career: "Prodygia", expert: alex}
